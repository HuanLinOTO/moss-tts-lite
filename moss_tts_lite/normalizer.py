# Vendored from models/MOSS-TTS-v1.5/tts_robust_normalizer_single_script.py
# (MOSS-TTS-v1.5, Apache-2.0) -- kept byte-for-byte identical except for this
# provenance header, so normalization behavior matches the reference exactly.
# Imports are stdlib-only (re, unicodedata); public API: normalize_tts_text.
